...
The first frame a player sees must make them think: _"This doesn't look like a student project."_
...
2. **Motion graphics** on every element — nothing appears, everything _arrives_
...
4. **Hand-gesture fatigue is real.** Gesture play is tiring; competitive precision modes need conventional controls. This is a _feature split_, not a compromise — see §1.3 P3. (Rule R4)
